...
// This is a copy of the Guava Preconditions implementation with the following modifications:
// - Removed @Nullable annotations to remove dependency on javax
// - Changed package name

package com.cloudera.recordservice.util;
