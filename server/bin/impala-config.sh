...
export IMPALA_HADOOP_VERSION=2.6.0-cdh5.9.0-SNAPSHOT
export IMPALA_HBASE_VERSION=1.2.0-cdh5.9.0-SNAPSHOT
export IMPALA_HIVE_VERSION=1.1.0-cdh5.9.0-SNAPSHOT
