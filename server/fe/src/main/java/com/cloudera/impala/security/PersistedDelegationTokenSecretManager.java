 ...
 */
public class PersistedDelegationTokenSecretManager extends DelegationTokenSecretManager {
  private static final Logger LOGGER =
      LoggerFactory.getLogger(PersistedDelegationTokenSecretManager.class.getName());

  final private long keyUpdateInterval;
  final private long tokenRemoverScanInterval;
  private Thread tokenRemoverThread;

  final private ZooKeeperTokenStore tokenStore;

  /**
   * Create a new secret manager which stores the tokens in ZK. All timing configs are
   * in milliseconds.
   */
  protected PersistedDelegationTokenSecretManager(long delegationKeyUpdateInterval,
      long delegationTokenMaxLifetime, long delegationTokenRenewInterval,
      long delegationTokenRemoverScanInterval,
      ZooKeeperTokenStore sharedStore) {
