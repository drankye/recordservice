...
public enum HdfsFileFormat {
  ...
  HIVE_SERDE("org.apache.hadoop.mapred.TextInputFormat",
      "org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat",
      "org.apache.hadoop.hive.serde2.lazy.LazySimpleSerDe"),
  ...
  RECORDSERVICE("com.cloudera.recordservice.mapred.RecordServiceInputFormat",
      "org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat",
  ...
  private static final Map<String, HdfsFileFormat> VALID_INPUT_FORMATS =
      ImmutableMap.<String, HdfsFileFormat>builder()
          ...
          .put(RECORDSERVICE.inputFormat(), RECORDSERVICE)
          .build();
